...
require_once 'KalkWynik.class.php';
...
class KalkKtrl {
	...
	public function generateView(){
		...
		getSmarty()->display('KalkWystl.html'); // już nie podajemy pełnej ścieżki - foldery widoków są zdefiniowane przy ładowaniu Smarty
	}
}
